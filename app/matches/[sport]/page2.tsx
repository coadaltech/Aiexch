      ...
      <div className="p-4 lg:p-6 space-y-6">
        ...
        <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-white/20 text-white">
          <CardContent className="p-0">
            ...
            {/* Horizontal Scroll Wrapper with Scrollbar on Top */}
            <div className="relative">
              {/* Custom scrollbar track (top) */}
                  ...
                  <div className="divide-y divide-white/10">
                    {filteredMatches.map((match) => (
                      <div
                        key={match.id}
                        className={cn(
                          // yahan se overflow-x-auto hata diya
                        ...
                        <div className="min-w-max grid grid-cols-12 gap-1 lg:gap-2 items-center w-full">
                          ...
                          <div className="col-span-1">
                            <Button
                              variant="outline"
                              size="sm"
                              className="w-full bg-cyan-500/20 border-cyan-500/50 text-white hover:bg-cyan-500/30 p-0.5"
                            >
                              <div className="text-center">
                                <div className="text-[14px] font-bold">{match.odds.team1.value}</div>
                                <div className="text-[12px] text-gray-300">{match.odds.team1.volume}</div>
                              </div>
                            </Button>
                          </div>
                          ...
                          <div className="col-span-1">
                            {match.odds.draw ? (
                              <Button
                                variant="outline"
                                size="sm"
                                className="w-full bg-yellow-500/20 border-yellow-500/50 text-white hover:bg-yellow-500/30 p-0.5"
                              >
                                <div className="text-center">
                                  <div className="text-[14px] font-bold">{match.odds.draw.value}</div>
                                  <div className="text-[12px] text-gray-300">{match.odds.draw.volume}</div>
                                </div>
                              </Button>
                            ) : (
                              <div className="w-full h-full flex items-center justify-center text-gray-500 text-[8px]">N/A</div>
                            )}
                          </div>
                          ...
                          <div className="col-span-1">
                            <Button
                              variant="outline"
                              size="sm"
                              className="w-full bg-pink-500/20 border-pink-500/50 text-white hover:bg-pink-500/30 p-0.5"
                            >
                              <div className="text-center">
                                <div className="text-[14px] font-bold">{match.odds.team2.value}</div>
                                <div className="text-[12px] text-gray-300">{match.odds.team2.volume}</div>
                              </div>
                            </Button>
                          </div>
